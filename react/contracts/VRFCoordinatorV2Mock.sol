...
contract VRFCoordinatorV2Mock is VRFCoordinatorV2Interface {
   ...
   */
  function fulfillRandomWords(uint256 _requestId, address _consumer, uint256 randomFirstNumber) external {
    ...
    words[0] = randomFirstNumber;
    for (uint256 i = 1; i < req.numWords; i++) {
